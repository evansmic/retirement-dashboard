...
S3728-S3747 is complete. Public optimizer copy and output-contract decisions are now explicit: review-direction runtime evidence is allowed for private pilot review, while saved optimizer output, CSV/report sequencing, production UI promotion, final annual instructions, tax-bracket wording, account-level withdrawal instructions, schema changes, and `.plan.json` sequencing output remain blocked. Current remaining estimate: retirement answer layer 0-10 sprints, live assumption lab 0 sprints, public-ready optimizer 0-2 sprints, graphical UI redesign 20-60 sprints, launch hardening 5-15 sprints.

Current package doc: [`docs/sprint_3728_3747_public_optimizer_output_contract.md`](docs/sprint_3728_3747_public_optimizer_output_contract.md).
...
S3628-S3647 is complete. The assumption lab now has an explicit scenario-scope decision: beta keeps one temporary applied adjustment at a time, defers named multi-assumption scenario sets until pilot evidence proves demand, keeps scenario results and applied assumption state out of saved plan files, and uses tester behaviour as a future visualization signal. Current remaining estimate: retirement answer layer 0-10 sprints, live assumption lab 0 sprints, public-ready optimizer 0-20 sprints, graphical UI redesign 20-60 sprints, launch hardening 10-30 sprints.

Current package doc: [`docs/sprint_3628_3647_assumption_lab_scenario_decision.md`](docs/sprint_3628_3647_assumption_lab_scenario_decision.md).

S3608-S3627 is complete. Details assumption-lab controls now separate pending slider edits from applied preview runs, with explicit Apply/Reset controls, pending/applied assumption summaries, progress feedback, and comparison deltas against the current plan. The lab remains temporary and local: it does not mutate saved plan inputs, persist scenario output, create account instructions, or turn the optimal review path into personal financial advice. Current remaining estimate: retirement answer layer 0-10 sprints, live assumption lab 0-10 sprints, public-ready optimizer 0-20 sprints, graphical UI redesign 20-60 sprints, launch hardening 10-30 sprints.

Current package doc: [`docs/sprint_3608_3627_assumption_lab_comparison_polish.md`](docs/sprint_3608_3627_assumption_lab_comparison_polish.md).

S3588-S3607 is complete. Details assumption-lab controls now rerun local preview working copies with progress feedback and refresh the optimal review path plus side-by-side comparison slots. Retirement age, early spending, residence sale date, and survivor year adjust a working-copy plan; CPP/OAS timing and investment return use runtime config overrides. The main editable plan is unchanged, scenario output is not persisted, and final advice/account-instruction language remains blocked. Current remaining estimate: retirement answer layer 0-10 sprints, live assumption lab 5-20 sprints, public-ready optimizer 0-20 sprints, graphical UI redesign 20-60 sprints, launch hardening 10-30 sprints.

Current package doc: [`docs/sprint_3588_3607_live_assumption_rerun_queue.md`](docs/sprint_3588_3607_live_assumption_rerun_queue.md).
...
S3448-S3467 is complete. The optimizer now has a fixture coverage implementation plan that names five synthetic fixture builders, shared no-output assertions, stop-condition assertions, and implementation batches for closing coverage gaps while public output remains closed. Results Details shows the plan without opening public release, real-data tester distribution, production UI, CSV/report sequencing, final instructions, tax-bracket wording, schema changes, or `.plan.json` sequencing output. Current remaining estimate: internal tester optimizer prototype 0 sprints, feature-complete app optimizer beta 0 sprints, and public-ready optimizer for real planning use 10-60 sprints.

Current package doc: [`docs/sprint_3448_3467_fixture_coverage_implementation_planning.md`](docs/sprint_3448_3467_fixture_coverage_implementation_planning.md).
