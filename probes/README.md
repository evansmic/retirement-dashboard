...
| `probe_single_plan_file_dashboard.js` | Dashboard regression for malformed single-person `.plan.json` exports where blank Person 2 was saved as a placeholder and zero retirement fields inflated spending/chart data | 8 |
...
**Total: 513 checks. All must pass — also enforced in CI (Sprint 1 #57) via `.github/workflows/probes.yml`.**
