...
8. In Details, look for the minimum-expense bridge, discretionary-room bridge, and spending-path bridge, then write down whether any of them help or confuse the spending answer.
...
- Did the discretionary-room bridge help explain possible room above the floor, or did it sound like permission to spend more?
