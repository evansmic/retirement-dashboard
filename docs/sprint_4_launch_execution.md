...
- Probe result: canonical suite **515 passed, 0 failed** on 2026-05-01
...
- [x] Canonical probes pass before release: **515 passed, 0 failed** on 2026-05-01.
- [x] README probe count matches the current documented suite result: 515 checks.
...
- [x] Canonical probe count recorded from a fresh run: **515 passed, 0 failed** on 2026-05-01.
