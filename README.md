...
Engine models federal + Ontario 2026 tax rules and the 515-check regression suite covers the core rules end-to-end. Sprint 1, Sprint 2, Sprint 0, and Sprint 3 are complete: trust gates, local `.plan.json` persistence, guided form navigation, blank-field validation, and recommended-plan framing are in place. Sprint 4 is the active launch/productization package. See [`ROADMAP.md`](ROADMAP.md).
