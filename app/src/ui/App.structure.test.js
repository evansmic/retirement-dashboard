...
describe('Results overview structure', () => {
  ...
  it('keeps the normal Details option surface compact while preserving full option research behind a gate', () => {
    ...
    expect(boundedPanel).toContain('readinessSectionIndex');
    expect(boundedPanel).toContain('readinessSectionIndex.headline');
    expect(boundedPanel).toContain('readinessSectionIndex.boundary');
    expect(boundedPanel).toContain('row.group');
    expect(boundedPanel).toContain('copyTighteningGuard');
    expect(boundedPanel).toContain('copyTighteningGuard.headline');
    expect(boundedPanel).toContain('copyTighteningGuard.boundary');
    expect(boundedPanel).toContain('feedbackExamplePointers');
    expect(boundedPanel).toContain('feedbackExamplePointers.headline');
    expect(boundedPanel).toContain('feedbackExamplePointers.boundary');
    expect(boundedPanel).toContain('deferralReassessment');
    expect(boundedPanel).toContain('deferralReassessment.headline');
    expect(boundedPanel).toContain('deferralReassessment.recommendation');
    expect(boundedPanel).toContain('deferralReassessment.boundary');
    expect(boundedPanel).toContain('readinessMaintenancePlan');
    expect(boundedPanel).toContain('readinessMaintenancePlan.headline');
    expect(boundedPanel).toContain('readinessMaintenancePlan.boundary');
    expect(boundedPanel).toContain('feedbackReviewScript');
    expect(boundedPanel).toContain('feedbackReviewScript.headline');
    expect(boundedPanel).toContain('feedbackReviewScript.boundary');
    expect(boundedPanel).toContain('performancePlanningQuestions');
    expect(boundedPanel).toContain('performancePlanningQuestions.headline');
    expect(boundedPanel).toContain('performancePlanningQuestions.boundary');
    expect(boundedPanel).toContain('conservativePostureCheckpoint');
    expect(boundedPanel).toContain('conservativePostureCheckpoint.headline');
    expect(boundedPanel).toContain('conservativePostureCheckpoint.recommendation');
    expect(boundedPanel).toContain('conservativePostureCheckpoint.boundary');
    expect(boundedPanel).toContain('readinessConsolidationSummary');
    expect(boundedPanel).toContain('readinessConsolidationSummary.headline');
    expect(boundedPanel).toContain('readinessConsolidationSummary.boundary');
    expect(boundedPanel).toContain('uiRedesignReadinessBridge');
    expect(boundedPanel).toContain('uiRedesignReadinessBridge.headline');
    expect(boundedPanel).toContain('uiRedesignReadinessBridge.boundary');
    expect(boundedPanel).toContain('checkpointArchivePolicy');
    expect(boundedPanel).toContain('checkpointArchivePolicy.headline');
    expect(boundedPanel).toContain('checkpointArchivePolicy.boundary');
    expect(boundedPanel).toContain('consolidationCheckpoint');
    expect(boundedPanel).toContain('consolidationCheckpoint.headline');
    expect(boundedPanel).toContain('consolidationCheckpoint.recommendation');
    expect(boundedPanel).toContain('consolidationCheckpoint.boundary');
    expect(boundedPanel).toContain('manualWorksheetPacket');
    expect(boundedPanel).toContain('manualWorksheetPacket.headline');
    expect(boundedPanel).toContain('manualWorksheetPacket.boundary');
    expect(boundedPanel).toContain('staticWorksheetExamples');
    expect(boundedPanel).toContain('staticWorksheetExamples.headline');
    expect(boundedPanel).toContain('staticWorksheetExamples.boundary');
    expect(boundedPanel).toContain('manualScoringRubric');
    expect(boundedPanel).toContain('manualScoringRubric.headline');
    expect(boundedPanel).toContain('manualScoringRubric.boundary');
    expect(boundedPanel).toContain('manualFeedbackPrepCheckpoint');
    expect(boundedPanel).toContain('manualFeedbackPrepCheckpoint.headline');
    expect(boundedPanel).toContain('manualFeedbackPrepCheckpoint.recommendation');
    expect(boundedPanel).toContain('manualFeedbackPrepCheckpoint.boundary');
    expect(boundedPanel).toContain('feedbackResultsPlaceholder');
    expect(boundedPanel).toContain('feedbackResultsPlaceholder.headline');
    expect(boundedPanel).toContain('feedbackResultsPlaceholder.boundary');
    expect(boundedPanel).toContain('feedbackCopyCleanupTargets');
    expect(boundedPanel).toContain('feedbackCopyCleanupTargets.headline');
    expect(boundedPanel).toContain('feedbackCopyCleanupTargets.boundary');
    ...
    expect(boundedPanel).toContain('feedbackResultsCheckpoint');
    ...
    expect(boundedPanel).toContain('prototypeDecisionRegister');
    expect(boundedPanel).toContain('prototypeDecisionRegister.headline');
    expect(boundedPanel).toContain('prototypeDecisionRegister.nextStep');
    expect(boundedPanel).toContain('prototypeDecisionRegister.boundary');
    expect(boundedPanel).toContain('rollbackContainmentPlan');
    expect(boundedPanel).toContain('rollbackContainmentPlan.headline');
    expect(boundedPanel).toContain('rollbackContainmentPlan.boundary');
    expect(boundedPanel).toContain('testOnlyShapePlan');
    expect(boundedPanel).toContain('testOnlyShapePlan.headline');
    expect(boundedPanel).toContain('testOnlyShapePlan.boundary');
    ...
    expect(boundedPanel).toContain('feedbackDecisionLedger');
    expect(boundedPanel).toContain('feedbackDecisionLedger.headline');
    expect(boundedPanel).toContain('feedbackDecisionLedger.boundary');
    expect(boundedPanel).toContain('row.evidenceNeeded');
    expect(boundedPanel).toContain('feedbackCoverageMatrix');
    expect(boundedPanel).toContain('feedbackCoverageMatrix.headline');
    expect(boundedPanel).toContain('feedbackCoverageMatrix.boundary');
    expect(boundedPanel).toContain('row.missingEvidence');
    expect(boundedPanel).toContain('evidenceQualityChecklist');
    expect(boundedPanel).toContain('evidenceQualityChecklist.headline');
    expect(boundedPanel).toContain('evidenceQualityChecklist.boundary');
    expect(boundedPanel).toContain('row.guardrail');
    expect(boundedPanel).toContain('prototypeDecisionPacket');
    expect(boundedPanel).toContain('prototypeDecisionPacket.headline');
    expect(boundedPanel).toContain('prototypeDecisionPacket.boundary');
    expect(boundedPanel).toContain('row.requiredBeforeAsk');
    expect(boundedPanel).toContain('readinessRunway');
    expect(boundedPanel).toContain('readinessRunway.headline');
    expect(boundedPanel).toContain('readinessRunway.recommendation');
    expect(boundedPanel).toContain('readinessRunway.boundary');
